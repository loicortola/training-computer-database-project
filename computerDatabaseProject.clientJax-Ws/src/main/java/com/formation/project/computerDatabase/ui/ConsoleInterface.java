package com.formation.project.computerDatabase.ui;
...
public class ConsoleInterface {
	...
	IComputerDatabaseWebServiceJaxWS service = null;

	public ConsoleInterface(IComputerDatabaseWebServiceJaxWS service) {
	...
	public void searchByComputerName() {
		...
		for(Computer c : service.getComputers(name, "")) {
	...
	public void searchByBoth() {
		...
		for(Computer c : service.getComputers(computerName, companyName)) {
			System.out.println(c.toString());
		}
